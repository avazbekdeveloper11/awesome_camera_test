...
import 'package:camerawesome/src/photofilters/utils/image_filter_utils.dart' as image_filter_utils;
import 'package:camerawesome/src/photofilters/utils/color_filter_utils.dart' as color_filter_utils;
...
class ConvolutionSubFilter implements ImageSubFilter {
  ...
  @override
  void apply(Uint8List pixels, int width, int height) =>
      image_filter_utils.convolute(pixels, width, height, _normalizeKernel(weights), bias);
